export default function HomeBannerContentBox() {
  return (
    <div className="w-full h-120 flex flex-col items-start bg-(--background-color)/90 rounded-2xl px-9 py-12">
      ...
      <button className="mt-auto bg-(--primary-color) text-white px-12 py-4 font-bold hover:bg-(--primary-color)/90 active:bg-(--primary-color)/80">
        Join the Auction
      </button>
    </div>
  );
